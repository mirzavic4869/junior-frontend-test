		...
		<div className="flex justify-center w-full px-4 py-12 md:p-18 lg:p-24">
			<form className="w-full px-12 py-8 space-y-4 bg-white rounded-md shadow-xl md:w-1/2" onSubmit={handleSubmit(submitForm)}>
				<div className="space-y-2">
					<label>Title:</label>
					<input
						className="w-full appearance-none rounded-md border border-solid border-[#e2e2e2] px-4 py-3 outline-none text-sm font-light placeholder-gray-400 focus:border-zinc-700 focus:ring-zinc-700"
